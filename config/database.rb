...
database_name = case Padrino.env
  when :development then 'simple_track_development'
  when :production  then 'simple_track_production'
  when :test        then 'simple_track_test'
end
...
#       default:
#         database: simple_track_development
#         hosts:
#           - localhost:27017
#
#   production:
#     clients: #Replace clients with sessions to work with Mongoid version 3.x or 4.x
#       default:
#         database: simple_track_production
#         hosts:
#           - localhost:27017
#
#   test:
